                ...
                <Layout className='pt-16'>
                    ...
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
                            ...
                            <p className='font-medium'>Hi, I'm Varsha G, a web developer and UI/UX designer with a passion for creating beautiful, functional,
                        ...
                        <div className='col-span-3 relative xl:col-span-4 md:order-1 md:col-span-8 h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:bg-dark dark:border-light'>
                            ...
                            <Image src={profilepic}alt="VARSHA IMAGE" className='w-full h-auto rounded-2xl' priority
